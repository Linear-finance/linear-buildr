...
echo "GRAPH_BUILDR_SWAP_BINANCE_MAINNET=\"${GRAPH_BUILDR_SWAP_ETHEREUM_MAINNET}\"" >> $ENV_FILE
...
echo "SUBGRAPH_LIQUIDATION_PORTAL_BINANCE_MAINNET=\"${SUBGRAPH_LIQUIDATION_PORTAL_BINANCE_MAINNET}\"" >> $ENV_FILE
echo "SUBGRAPH_LIQUIDATION_PORTAL_BSC_DEV=\"${SUBGRAPH_LIQUIDATION_PORTAL_BSC_DEV}\"" >> $ENV_FILE
echo "WORMHOLE_RPC=\"${WORMHOLE_RPC}\"" >> $ENV_FILE
